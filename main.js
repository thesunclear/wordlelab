...
function fmt3WithHover(x) {
  ...
  // Display 3 decimals, but keep full precision in the title tooltip
  return { text: x.toFixed(3), title: String(x) };
}
...
function getFirstGuessJsonFile(){
  ...
  if (!ansKey) return { error: "Please choose Answer List = 2309 or 3207 to use First Guess Advisor." };
